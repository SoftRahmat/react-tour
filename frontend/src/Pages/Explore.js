...
class Explore extends Component {
  ...
  componentDidMount = async(e) =>{
    ...
    Axios({
      ...
      url: "https://shrieking-asylum-35940.herokuapp.com/hotelsearch",
      data:{
            ...
            if(!this.state.userstatus) alert("Heads up: Unlesss you're logged in, you won't be able to book!")
              ...
              this.setState({ progress: 1 });
                Axios({
                    method: "POST",
                    withCredentials: true,
                    url: "https://shrieking-asylum-35940.herokuapp.com/date",
                    data:{
    ...
    Axios({
      ...
      if(res.data){
        Axios({
          method: "POST",
          withCredentials: true,
          url: "https://shrieking-asylum-35940.herokuapp.com/book",
          data:{
