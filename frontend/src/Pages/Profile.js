...
class Profile extends Component {
  ...
  componentDidMount() {
    Axios({
      ...
      url: "https://shrieking-asylum-35940.herokuapp.com/getuser",
    }).then((res) => {
    ...
    Axios({
      method: "GET",
      withCredentials: true,
      url: "https://shrieking-asylum-35940.herokuapp.com/getbucketlist",
    }).then((res) => {
    ...
    logout = () => {
      Axios({
        method: "GET",
        withCredentials: true,
        url: "https://shrieking-asylum-35940.herokuapp.com/logout",
      }).then((res) => {
    ...
    updateNum = () => {
      Axios({
        ...
        withCredentials: true,
        url: "https://shrieking-asylum-35940.herokuapp.com/update/number",
    ...
    updateAdd = () => {
      Axios({
        ...
        withCredentials: true,
        url: "https://shrieking-asylum-35940.herokuapp.com/update/address",
      }).then((res) => console.log(res));
      window.location.reload(false);
    };
      ...
      return (
        <div>
          <div className="banner">
            <NavbarComp />
            <Image src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/1f/a0/c3.jpg"  width="100%"/>  
          </div>
