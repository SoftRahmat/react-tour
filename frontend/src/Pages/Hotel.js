...
class Hotel extends Component {
  ...
  componentDidMount() {
    ...
    Axios({
      ...
      url: "https://shrieking-asylum-35940.herokuapp.com/gethotelbyid/" + url.split("/")[2] + "/" + url.split("/")[3] + "/" + url.split("/")[4] ,
    }).then((res) => {  
      if (res.data){
  ...
  handleBucketList(){
    ...
    Axios({
      method: "POST",
      withCredentials: true,
      url: "https://shrieking-asylum-35940.herokuapp.com/addtobucketlist/" + hotel_id,
    }).then((res) => {  
      if (res.data){
  ...
  handleSubmit = async(e) => {
    ...
    Axios({
      ...
      withCredentials: true,
      url: "https://shrieking-asylum-35940.herokuapp.com/addreview",
    }).then(function (res) {
      console.log(res);
  ...
  handleBook(){
    ...
    Axios({
      ...
      url: "https://shrieking-asylum-35940.herokuapp.com/bookhotel",
    }).then((res) => {  
      if (res.data){
        console.log(res.data);
      }
